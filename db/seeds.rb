...
krisl3 = Log.create(log_date: (Date.current + 2), worked_out: "0", tracked_food: "1", weight: "132.57", body_fat: ".2075", active_calories: "800", calories: "2500", user: kris)
krisl2 = Log.create(log_date: (Date.current + 3), worked_out: "0", tracked_food: "0", weight: "133.57", body_fat: ".2175", active_calories: "700", calories: "2300", user: kris)
timl1 = Log.create(log_date: (Date.current + 1), worked_out: "1", tracked_food: "1", weight: "165.57", body_fat: ".2575", active_calories: "300", calories: "3200", user: tim)
...
timl3 = Log.create(log_date: (Date.current + 3), worked_out: "1", tracked_food: "0", weight: "163.57", body_fat: ".2475", active_calories: "500", calories: "3200", user: tim)
patrickl1 = Log.create(log_date: (Date.current + 13), worked_out: "1", tracked_food: "1", weight: "185.57", body_fat: ".2975", active_calories: "600", calories: "3200", user: patrick)
patrickl2 = Log.create(log_date: (Date.current + 14), worked_out: "0", tracked_food: "1", weight: "184.57", body_fat: ".2875", active_calories: "600", calories: "3200", user: patrick)
patrickl3 = Log.create(log_date: (Date.current + 15), worked_out: "1", tracked_food: "0", weight: "183.57", body_fat: ".2775", active_calories: "600", calories: "3200", user: patrick)
joel1 = Log.create(log_date: (Date.current + 31), worked_out: "1", tracked_food: "1", weight: "185.57", body_fat: ".2975", active_calories: "600", calories: "3200", user: joe)
joel2 = Log.create(log_date: (Date.current + 32), worked_out: "0", tracked_food: "1", weight: "184.57", body_fat: ".2875", active_calories: "600", calories: "3200", user: joe)
joel3 = Log.create(log_date: (Date.current + 33), worked_out: "1", tracked_food: "1", weight: "183.57", body_fat: ".2775", active_calories: "600", calories: "3200", user: joe)
